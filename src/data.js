...
export const bosses = [
  ...
  },
  {
    ...
    abilities: [
      ...
      ['Astral Energy', 'Shoots waves of energy; rotate around the boss. Deals 50+ damage and applies Grievous Injury.', 'MOVE', 'The initial hit deals roughly 50 or more damage and applies Grievous Injury, lowering damage resistance. Rotate around the boss to avoid the waves rather than letting them overlap the group.', mechanic('astral-focused-energy.webp')],
      ['Stardust Shower', 'Spawns bombs on players that fall and detonate after 2 seconds. Deals 50+ damage and applies Backlash.', 'MOVE', 'Stardust Shower places bombs on players. They take roughly 2 seconds to fall and detonate, so keep moving and avoid overlapping allies. Its Backlash debuff increases the victim’s chance to fizzle spell casts until the effect ends.', mechanic('astral-fireball.webp')],
