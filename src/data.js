...
export const bosses = [
  ...
  },
  {
    ...
    summary: 'The hardest-hitting Omni melee profile, combining interactive Abyssal Spheres with disease explosions, prisons, close-range fury, and Rift Daemon waves.',
    abilities: [
      ['Abyssal Spheres', 'Creates interactive spheres around the raid. Double-click or attack them immediately, then return to the boss once the sphere wave is cleared.'],
      ['Abyssal Doom', 'Green skull-like impacts leave a brief puff before exploding and applying severe Disease. Move as soon as the green warning appears.'],
      ['Void Prisons', 'Forms prisons around players, splitting the raid and obstructing movement during overlapping hazards.'],
      ['Terrifying Fury', 'Unleashes a punishing close-range burst around the boss. Melee players should spread away when Fury is called, then collapse back in.'],
      ['Abyssal Claws', 'Telegraphs ground-reaching claw attacks that punish stationary targets. Keep moving until the sequence ends.'],
      ['Rift Daemons', 'Summons large Rift Daemons around the arena. Stop boss damage and eliminate them before they reach the resurrection area.'],
    ],
    tips: ['Stay near the raid between mechanics so spheres and adds remain manageable.', 'Leave green smoke immediately and spread for Terrifying Fury.', 'Clear Spheres first and Rift Daemons second before resuming boss damage.'],
  },
  {
    ...
    summary: 'The most magic-resistant Omni variant, built around directional cosmic attacks, falling stardust, dangerous pillars, reflective mirrors, and heavy add control.',
    abilities: [
      ['Astral Energy / Cosmic Rays', 'Projects a repeated forward cone from the boss. Leave its facing immediately and remain clear until the sequence finishes.'],
      ['Stardust Shower', 'Drops rapid impacts across changing parts of the arena. Keep moving out of the affected region, then return when the shower clears.'],
      ['Pillars of Creation', 'Raises stationary pillars that fire astral orbs over long distances. Move away from every pillar rather than fighting beside it.'],
      ['Astral Mirrors', 'Creates interactive mirrors around the arena. Double-click or damage each mirror; reflections can punish continued ranged or spell damage while they remain.'],
      ['Astral Reinforcements', 'Summons named adds and Rift Daemons. Named adds reinforce the encounter while alive, so clear them before returning to the boss.'],
    ],
    tips: ['Never remain in front of the boss during Astral Energy.', 'Move completely out of Stardust and Pillar range.', 'Pause boss damage to clear mirrors, named adds, and Rift Daemons.'],
  },
  {
    ...
    summary: 'A movement-intensive Omni encounter where charged orbs chase attackers while tornadoes, lightning, rods, and Rift Daemons saturate the arena.',
    abilities: [
      ['Charged Orbs', 'Releases moving lightning orbs that pursue selected attackers. An overhead warning identifies the target; move the orbs away from the raid instead of crossing the group.'],
      ['Lightning Rods', 'Creates interactive rods around the arena. Double-click or damage them quickly to reduce the number of large lightning strikes.'],
      ['Tornadoes', 'Sends roaming tornado hazards through the battlefield. Their damaging area can extend beyond the visible graphic, so give them extra space.'],
      ['Overcharge', 'Marks a player before a brutal charge or displacement attack. Start moving when the Overcharge warning appears and avoid carrying it through stacked allies.'],
      ['Lightning Strikes', 'Calls persistent lightning impacts at player and boss positions. Watch the floor and relocate before multiple strikes overlap.'],
      ['Rift Daemons', 'Summons Rift Daemons at distant edges and near the resurrection area. Assign an add team so they do not accumulate.'],
    ],
    tips: ['Spread ranged attackers so attracted orbs do not converge on the raid.', 'Destroy Lightning Rods immediately.', 'Avoid combinations of tornadoes and lightning rather than trying to tank both.'],
  },
  {
