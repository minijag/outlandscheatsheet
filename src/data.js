...
export const bosses = [
  ...
  },
  {
    ...
    abilities: [
      ...
      ['Focused Astral Energy', 'Deals 50+ damage and applies Grievous Injury, reducing damage resistance.', 'BRACE', 'The initial hit deals roughly 50 or more damage. Grievous Injury then lowers the affected player’s damage resistance, making overlapping mechanics substantially more dangerous.'],
      ...
      ['Cosmic Rays', 'Deal 50+ damage and apply Festering Wound, reducing healing received.', 'BRACE', 'Cosmic Rays hit for roughly 50 or more damage and apply Festering Wound. The wound reduces all healing received by the affected player.'],
